...
### Creating a Custom Page (e.g., Mynk Page)

If you want a page accessible at:

_http://localhost:3000/mynk_

Follow the same steps as above:

1. Inside _src/app_, create a folder named _mynk_.
2. Inside _mynk_, create a _page.tsx_ file.
3. Add the following code:

```tsx
export default function Mynk() {
  return <h1>Hello from Mynk</h1>;
}
```
